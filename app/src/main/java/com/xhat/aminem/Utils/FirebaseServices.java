...
public class FirebaseServices extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            try {
                ...
                Log.e(TAG, "JSON Object: " + jsonParse.toString());
                Log.d(TAG, "Created By: " + jsonParse.getString("created_by"));
                Log.d(TAG, "Item ID: " + jsonParse.getString("item_id"));

                showNotif(jsonParse.getString("title"), jsonParse.getString("body"));
    ...
    public void showNotif(String title, String message){
        ...
        NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(this, "NotifApps")
                ...
                .setSmallIcon(R.drawable.ic_time) // icon
